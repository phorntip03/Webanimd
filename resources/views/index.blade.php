...
<nav class="navbar header-navbar pcoded-header">
    <div class="navbar-wrapper">
        ...
        <div class="navbar-logo">
            ...
            <a href="index.html">
                <img class="img-fluid" src="{{Asset('Asset/backend/images/logo.png')}}" alt="Theme-Logo" />
            </a>
            ...
            <ul class="nav-right">
                <li class="header-notification">
                    ...
                    <ul class="show-notification">
                        ...
                        <li>
                            <div class="media">
                                <img class="d-flex align-self-center img-radius" src="{{Asset('Asset/backend/assets/images/avatar-4.jpg')}}" alt="Generic placeholder image">
                        ...
                        <li>
                            <div class="media">
                                <img class="d-flex align-self-center img-radius" src="{{Asset('Asset/backend/assets/images/avatar-3.jpg')}}" alt="Generic placeholder image">
                                <div class="media-body">
                ...
                <li class="user-profile header-notification">
                    <a href="#!">
                        <img src="{{Asset('Asset/backend/images/avatar-4.jpg')}}" class="img-radius" alt="User-Profile-Image">
                        <span>John Doe</span>
                                                ...
                                                <div class="checkbox-fade fade-in-primary d-block">
                                                    <label class="check-task d-block">
                                                        ...
                                                        <div class="task-card-img m-l-40">
                                                            <a href="#!"><img src="{{Asset('Asset/backend/images/avatar-2.jpg')}}" data-toggle="tooltip" title="Lary Doe" alt="" class="img-40"></a>
                                                            <a href="#!"><img src="{{Asset('Asset/backend/images/avatar-3.jpg')}}" data-toggle="tooltip" title="Alia" alt="" class="img-40 m-l-10"></a>
                                                        </div>
                                                    </label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="to-do-list">
                                                <div class="checkbox-fade fade-in-primary d-block">
                                                    <label class="check-task d-block">
                                                        ...
                                                        <div class="task-card-img m-l-40">
                                                            <a href="#!"><img src="{{Asset('Asset/backend/images/avatar-2.jpg')}}" data-toggle="tooltip" title="Alia" alt="" class="img-40"></a>
                                                            <a href="#!"><img src="{{Asset('Asset/backend/images/avatar-3.jpg')}}" data-toggle="tooltip" title="Suzen" alt="" class="img-40 m-l-10"></a>
                                                            <a href="#!"><img src="{{Asset('Asset/backend/images/avatar-4.jpg')}}" data-toggle="tooltip" title="Lary Doe" alt="" class="img-40 m-l-10"></a>
                                                            <a href="#!"><img src="{{Asset('Asset/backend/images/avatar-2.jpg')}}" data-toggle="tooltip" title="Josephin Doe" alt="" class="img-40 m-l-10"></a>
                                                        </div>
                                                    </label>
                                                </div>
                                            </div>
